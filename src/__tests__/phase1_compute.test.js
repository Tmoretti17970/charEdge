...
describe('1.2.1 — ComputeWorkerPool wired into indicator computation', () => {
  ...
  it('IndicatorWorkerBridge routes through ComputeWorkerPool', () => {
...
describe('1.2.2 — WebGPU Compute connected to render pipeline', () => {
  ...
  beforeAll(() => {
    gpuStageSource = readSource('charting_library/core/stages/GPUComputeStage.js');
    pipelineSource = readSource('charting_library/core/RenderPipeline.js');
    engineSource = readSource('charting_library/core/ChartEngine.js');
  });

  it('GPUComputeStage.js exists and exports executeGPUComputeStage', () => {
...
describe('1.3.1 — DataSharedWorker wired for cross-tab WS dedup', () => {
  ...
  beforeAll(() => {
    ...
    tickerSource = readSource('data/engine/streaming/TickerPlant.js');
  });
