...
export function kellySize(input: KellyInput): SizingResult {
    ...
    let kellyFraction = (winLossRatio * p - lossRate) / winLossRatio;
    ...
    // Store the uncapped full Kelly before any modifications
    const uncappedFullKelly = kellyFraction;
    ...
    return {
        ...
        details: {
            ...
            fullKelly: Math.round(uncappedFullKelly * 10000) / 10000,
            edge: Math.round((winLossRatio * p - lossRate) * 10000) / 100,
