...
export default function ReplayToolbar({
  ...
  return (
    <div className={s.toolbar}>
      ...
      {/* Step Forward */}
      <ToolbarButton onClick={onStep} disabled={isLoading || isPlaying} title="Step Forward (→)">
        ⏭
      </ToolbarButton>

      {/* Stop */}
      <ToolbarButton onClick={onStop} disabled={isLoading} title="Stop Replay (Esc)">
        ⏹
      </ToolbarButton>
      ...
      {paperTrade && (
        <>
          ...
          <button
            onClick={() => {
              paperTrade.placeTrade('long', qty);
              setStats(paperTrade.getStats());
            }}
            title="Buy Long"
            className={s.longBtn}
          ...
          <button
            onClick={() => {
              paperTrade.placeTrade('short', qty);
              setStats(paperTrade.getStats());
            }}
            title="Sell Short"
