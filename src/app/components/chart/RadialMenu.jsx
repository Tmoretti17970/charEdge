// ═══════════════════════════════════════════════════════════════════
// charEdge — Radial Context Menu (v3 Compact)
// Compact radial menu on right-click. Theme-aware glass design.
...
const SEGMENTS = [
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 18 18" fill="none">
        <path d="M13.5 2l2.5 2.5-10 10H3.5v-2.5l10-10z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 18 18" fill="none">
        <path d="M2 14l4-4 3 2 5-7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <polyline points="11,5 14,5 14,8" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 18 18" fill="none">
        <path d="M9 2c-3 0-5 2.5-5 5.5 0 3-1.5 4.5-1.5 4.5h13S14 10.5 14 7.5C14 4.5 12 2 9 2z" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
  ...
  },
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 18 18" fill="none">
        <polyline points="2,12 5,6 8,10 11,4 15,8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  ...
  {
    id: 'screenshot', label: 'Snap',
    icon: (
      <svg width="14" height="14" viewBox="0 0 18 18" fill="none">
        <rect x="2" y="4" width="14" height="11" rx="2" stroke="currentColor" strokeWidth="1.3" />
        <circle cx="9" cy="9.5" r="3" stroke="currentColor" strokeWidth="1.2" />
...
export default function RadialMenu({ x, y, price, onAction, onClose }) {
  ...
  // Single click fires default action; double-click opens submenu
  ...
  const glassBlur = 'blur(14px) saturate(1.4)';
    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 2,
          opacity: entered ? (activeSegment ? 0.3 : 1) : 0,
          transform: entered ? 'scale(1)' : 'scale(0.5)',
          transition: 'all 0.25s cubic-bezier(0.34, 1.56, 0.64, 1)',
          boxShadow: shadow,
        }}
      >
        <span style={{ fontSize: 8, color: C.t2, fontFamily: F, fontWeight: 600 }}>
          {price?.toFixed(0) ?? '•'}
        </span>
      </div>
        ...
        return (
          <button
            ...
            style={{
              ...
              backdropFilter: glassBlur,
              WebkitBackdropFilter: glassBlur,
              border: `1px solid ${isActive ? seg.color : borderColor}`,
              ...
              boxShadow: isActive
                ? `0 0 12px color-mix(in srgb, ${seg.color} 20%, transparent), ${shadow}`
                : shadow,
              ...
              transitionDelay: entered ? '0s' : `${i * 0.03}s`,
              pointerEvents: isDimmed ? 'none' : 'auto',
            }}
            onMouseEnter={(e) => {
              if (!isDimmed) {
                e.currentTarget.style.transform = isActive ? 'scale(1.08)' : 'scale(1.14)';
          ...
          >
            ...
            <span style={{
              fontSize: 6, fontWeight: 700, fontFamily: F,
      ...
      {activeSegment && subItems.map((item, i) => {
        ...
        const spreadDeg = Math.min(40, 160 / Math.max(count, 1));
        ...
        return (
          ...
          >
            ...
            <span style={{
              fontSize: 5.5, fontWeight: 700, fontFamily: F,
              letterSpacing: '0.2px', lineHeight: 1, opacity: 0.85,
              whiteSpace: 'nowrap',
            }}>
              {item.label}
            </span>
        ...
        {SEGMENTS.map((seg, i) => {
          ...
          return (
            <line
              ...
              stroke={borderColor}
              strokeWidth="0.5"
              opacity={entered ? (isDimmed ? 0.06 : 0.2) : 0}
      ...
      {/* Inline keyframes — avoids CSS module hashing issues */}
      <style>{`
        @keyframes rmSubIn {
