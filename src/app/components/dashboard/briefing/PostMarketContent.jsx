...
export default function PostMarketContent({ stats, isMobile, streakText }) {
    ...
    return (
        <>
            {/* Session Grade */}
            {stats.todayCount > 0 && (
                <BriefingTile title="SESSION GRADE" isMobile={isMobile} style={{ marginRight: 10, flex: '0 0 auto', minWidth: 100 }}>
            ...
            {stats.todayBest && stats.todayWorst && stats.todayCount > 1 && (
                <BriefingTile title="BEST / WORST" isMobile={isMobile} style={{ marginRight: 10, flex: '0 0 auto', minWidth: 150 }}>
