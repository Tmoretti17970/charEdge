...
export default function ActiveSessionContent({ stats, riskUsed, riskRemaining, dailyLossLimit, isMobile, _streakText }) {
        ...
        <>
            ...
            {dailyLossLimit > 0 && (
                <BriefingTile
                    ...
                    isMobile={isMobile}
                    style={{
                        marginRight: 10, flex: '0 0 auto', minWidth: 140,
                        borderColor: isDanger ? C.r + '40' : isWarning ? C.y + '40' : undefined,
                    }}
                >
                    <div style={{ width: '100%', height: 6, background: C.bg2, borderRadius: 3, overflow: 'hidden', marginBottom: 6 }}>
                        <div style={{
                            width: `${Math.min(100, riskUsed)}%`, height: '100%',
