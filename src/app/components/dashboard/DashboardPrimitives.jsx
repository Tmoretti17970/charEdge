...
export function NarrativeSectionHeader({ label, description }) {
  return (
...
export function NarrativeDivider() {
  return (
    <div
      className={`tf-narrative-divider ${s.divider}`}
      style={{ background: `linear-gradient(90deg, transparent, ${C.bd}60, transparent)` }}
    />
  );
}
