...
export default function CopilotPanel() {
  ...
  return (
    <>
      ...
      >
        {/* Desktop resize handle */}
        {!isMobile && <div className={st.resizeHandle} onMouseDown={handleResizeStart} title="Drag to resize" />}
        ...
        {showScrollBtn && hasMessages && (
          <button className={st.scrollFab} onClick={scrollToBottom} aria-label="Scroll to bottom">
            ↓
          </button>
        )}
