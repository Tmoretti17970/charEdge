            ...
            <div style={{ height: 6, borderRadius: 3, background: alpha(C.r, 0.3), overflow: 'hidden' }}>
              <div
                style={{
                  ...
                  background: `linear-gradient(90deg, ${C.g}, ${alpha(C.g, 0.7)})`,
                  borderRadius: 3,
                }}
              />
            </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    gap: 4,
                    padding: '8px 10px',
                    background: alpha(C.sf, flow.sweep ? 0.8 : 0.4),
                    border: `1px solid ${flow.sweep ? alpha(C.y, 0.2) : alpha(C.bd, 0.3)}`,
                    borderRadius: 6,
                    alignItems: 'center',
                    fontSize: 11,
                    fontFamily: 'var(--tf-mono)',
                ...
                >
                  ...
                  <span style={{ fontWeight: 700, color: C.t1, fontFamily: 'var(--tf-font)', fontSize: 12 }}>
                    {flow.symbol}
                  </span>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <span
                      style={{
                        ...
                        background: alpha(isBull ? C.g : C.r, 0.1),
                        padding: '2px 6px',
                        borderRadius: 4,
                      }}
                    >
