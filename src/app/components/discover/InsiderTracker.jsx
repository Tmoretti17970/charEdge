...
const MOCK_INSIDER = [
  ...
  { id: 2, date: '2026-02-24', symbol: 'AAPL', name: 'Tim Cook', role: 'CEO', action: 'Sell', shares: 50000, price: 198.40, value: 9920000, pctHoldings: 0.8, cluster: false },
  { id: 3, date: '2026-02-23', symbol: 'MSFT', name: 'Satya Nadella', role: 'CEO', action: 'Sell', shares: 30000, price: 415.80, value: 12474000, pctHoldings: 0.4, cluster: false },
  { id: 4, date: '2026-02-23', symbol: 'JPM', name: 'Jamie Dimon', role: 'CEO', action: 'Buy', shares: 25000, price: 198.20, value: 4955000, pctHoldings: 0.2, cluster: true },
  { id: 5, date: '2026-02-23', symbol: 'JPM', name: 'Mary Erdoes', role: 'Director', action: 'Buy', shares: 15000, price: 197.80, value: 2967000, pctHoldings: 1.2, cluster: true },
  { id: 6, date: '2026-02-22', symbol: 'AMZN', name: 'Andrew Jassy', role: 'CEO', action: 'Sell', shares: 40000, price: 185.60, value: 7424000, pctHoldings: 0.5, cluster: false },
  { id: 7, date: '2026-02-22', symbol: 'META', name: 'Mark Zuckerberg', role: 'CEO', action: 'Sell', shares: 200000, price: 498.40, value: 99680000, pctHoldings: 0.1, cluster: false },
  { id: 8, date: '2026-02-21', symbol: 'TSLA', name: 'Robyn Denholm', role: 'Chair', action: 'Sell', shares: 18000, price: 248.50, value: 4473000, pctHoldings: 2.5, cluster: false },
  { id: 9, date: '2026-02-21', symbol: 'GS', name: 'David Solomon', role: 'CEO', action: 'Buy', shares: 8000, price: 412.80, value: 3302400, pctHoldings: 0.6, cluster: true },
  { id: 10, date: '2026-02-21', symbol: 'GS', name: 'John Waldron', role: 'COO', action: 'Buy', shares: 5000, price: 413.20, value: 2066000, pctHoldings: 0.9, cluster: true },
  { id: 11, date: '2026-02-20', symbol: 'HD', name: 'Ted Decker', role: 'CEO', action: 'Buy', shares: 12000, price: 378.50, value: 4542000, pctHoldings: 1.8, cluster: false },
  { id: 12, date: '2026-02-20', symbol: 'LLY', name: 'David Ricks', role: 'CEO', action: 'Sell', shares: 22000, price: 785.20, value: 17274400, pctHoldings: 0.3, cluster: false },
];

const CONGRESS_TRADES = [
  { id: 'c1', date: '2026-02-23', member: 'Sen. T. Tuberville', party: 'R', symbol: 'NVDA', action: 'Buy', amount: '$250K–$500K' },
  { id: 'c2', date: '2026-02-22', member: 'Rep. N. Pelosi', party: 'D', symbol: 'GOOGL', action: 'Buy', amount: '$1M–$5M' },
  { id: 'c3', date: '2026-02-21', member: 'Sen. M. Kelly', party: 'D', symbol: 'MSFT', action: 'Buy', amount: '$100K–$250K' },
