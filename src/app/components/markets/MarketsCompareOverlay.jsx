    ...
    >
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 10, fontWeight: 700, fontFamily: F, color: C.t3, marginBottom: 8 }}>
            STATS
          </div>
          {symbolData.map((sym) => (
            <div key={sym.symbol} style={{ marginBottom: 10 }}>
              <div style={{
                fontSize: 11, fontWeight: 700, fontFamily: F, color: sym.color,
                display: 'flex', alignItems: 'center', gap: 4,
              }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: sym.color }} />
                {sym.symbol.replace('USDT', '')}
              </div>
              <div style={{ fontSize: 10, fontFamily: M, color: C.t2, marginTop: 2 }}>
              ...
              <div style={{
                fontSize: 10, fontWeight: 700, fontFamily: M, marginTop: 1,
