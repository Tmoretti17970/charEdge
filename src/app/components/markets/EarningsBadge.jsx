    ...
    >
      ...
      {hover && (
        <div style={{
          ...
          marginTop: 6, width: 220, padding: '10px 12px',
          ...
          {last && (
            <div style={{
              padding: '6px 8px', borderRadius: radii.sm,
              background: C.bg2, fontSize: 10, color: C.t3,
            }}>
              <div style={{ fontWeight: 700, color: C.t2, marginBottom: 3 }}>
                Last: {last.date}
              </div>
              <div>
                ...
                <span style={{
                  ...
                  {last.beat ? '✅ Beat' : '❌ Miss'} ({last.surprise > 0 ? '+' : ''}{last.surprise?.toFixed(1)}%)
                </span>
              </div>
            </div>
          )}
