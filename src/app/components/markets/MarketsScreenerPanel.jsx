  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 10, color: C.t3, fontFamily: 'var(--tf-font)', marginTop: 1 }}>{item.name}</div>
      </div>
...
function PresetCard({ preset, active, count, onClick }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: 10, color: C.t3, marginTop: 3 }}>{preset.description}</div>
    </button>
  );
}
...
function MarketsScreenerPanel({ open, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 15, fontWeight: 800, color: C.t1 }}>🔍 Screener</div>
        <button
          onClick={onClose}
          style={{
            background: 'none',
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '14px 16px' }}>
        ...
        {loading ? (
          <div style={{ textAlign: 'center', color: C.t3, fontSize: 12, padding: 20 }}>Scanning…</div>
        ) : results.length === 0 ? (
