    ...
    <Card className={st.cardPad}>
      <div className={st.header}>
        ...
        {otherSessions.length > 0 && (
          <Btn variant="ghost" onClick={handleSignOutOthers} style={{ fontSize: 11, padding: '4px 12px', color: C.r }}>
            Sign Out Others
          </Btn>
        )}
      </div>
          ...
          >
            ...
            <div className={st.deviceInfo}>
              <div className={st.deviceNameRow}>
                ...
                {session.isCurrent && (
                  <span className={st.currentBadge} style={{ color: C.b, background: C.b + '15' }}>
                    THIS DEVICE
                  </span>
                )}
              </div>
            ...
            {!session.isCurrent && (
              <button
                ...
                className={`tf-btn ${st.signOutBtn}`}
                style={{ border: `1px solid ${C.r}30`, color: C.r }}
              >
                Sign Out
              </button>
            )}
