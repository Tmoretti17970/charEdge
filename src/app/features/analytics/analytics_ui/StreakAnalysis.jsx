  ...
  return (
    <div>
      ...
      <Card style={{ padding: 16, marginBottom: 16 }}>
        ...
        <div style={{
          fontSize: 9, color: C.t3, fontFamily: M, marginTop: 8,
          borderTop: `1px solid ${C.bd}30`, paddingTop: 6,
        }}>
      ...
      {recoveries.length > 0 && (
        <Card style={{ padding: 16, marginBottom: 16 }}>
          ...
          <div style={{
            fontSize: 12, color: C.t2, lineHeight: 1.6, marginTop: 4, marginBottom: 12,
          }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {recoveries.slice(-5).map((r, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  fontSize: 11, fontWeight: 700, fontFamily: M, color: C.r,
                  minWidth: 50,
                }}>
                ...
                <div style={{
                  fontSize: 11, fontWeight: 600, fontFamily: M, color: C.t2,
                }}>
                ...
                <div style={{
                  ...
                  color: C.r, fontVariantNumeric: 'tabular-nums',
                }}>
                  -{fmtD(r.deficit)}
                </div>
              </div>
      ...
      {result?.tiltTradesCount > 0 && (
        <Card style={{
          ...
          <div style={{ fontSize: 12, color: C.t2, lineHeight: 1.6 }}>
            <strong style={{ color: C.r }}>{result.tiltTradesCount} trades</strong> were taken within 15 minutes
            of a loss, costing{' '}
            <strong style={{ color: C.r }}>{fmtD(result.tiltPnl)}</strong>.
          </div>
        </Card>
      )}
    </div>
