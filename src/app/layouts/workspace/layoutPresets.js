        ...
        children: [
          {
            ...
            weight: 50,
            children: [
              { type: 'tabset', weight: 33, children: [chartTab('ES', '1h')] },
              { type: 'tabset', weight: 33, children: [chartTab('NQ', '1h')] },
              { type: 'tabset', weight: 34, children: [chartTab('BTC', '1h')] },
            ],
          },
          {
            type: 'column',
            weight: 50,
            children: [
              { type: 'tabset', weight: 33, children: [chartTab('ETH', '1h')] },
              { type: 'tabset', weight: 33, children: [chartTab('SPY', '1h')] },
              { type: 'tabset', weight: 34, children: [chartTab('SOL', '1h')] },
            ],
          },
        ],
      },
        ...
        children: [
          {
            ...
            weight: 25,
            children: [
              { type: 'tabset', weight: 50, children: [chartTab('ES', '1h')] },
              { type: 'tabset', weight: 50, children: [chartTab('NQ', '1h')] },
            ],
          },
          {
            type: 'column',
            weight: 25,
            children: [
              { type: 'tabset', weight: 50, children: [chartTab('BTC', '1h')] },
              { type: 'tabset', weight: 50, children: [chartTab('ETH', '1h')] },
            ],
          },
          {
            type: 'column',
            weight: 25,
            children: [
              { type: 'tabset', weight: 50, children: [chartTab('SPY', '1h')] },
              { type: 'tabset', weight: 50, children: [chartTab('AAPL', '1h')] },
            ],
          },
          {
            type: 'column',
            weight: 25,
            children: [
              { type: 'tabset', weight: 50, children: [chartTab('SOL', '1h')] },
              { type: 'tabset', weight: 50, children: [chartTab('DOGE', '1h')] },
            ],
          },
        ],
      },
