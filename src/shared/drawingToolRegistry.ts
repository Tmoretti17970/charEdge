...
const DI = ({ children }: { children: React.ReactNode }) =>
  React.createElement(
    'svg',
    { width: S, height: S, viewBox: '0 0 14 14', fill: 'none', style: { display: 'block' } },
    children,
  );
...
export const TOOL_ICONS: Record<string, React.ReactNode> = {
  ...
  extendedline: React.createElement(
    DI,
    null,
    React.createElement('line', {
      x1: 0,
  ...
  polyline: React.createElement(
    DI,
    null,
    React.createElement('polyline', {
      points: '2,11 5,4 8,9 11,3',
      stroke: 'currentColor',
      strokeWidth: 1.3,
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  fibtimezone: React.createElement(
    DI,
    null,
    React.createElement('line', {
      x1: 3,
  ...
  fibchannel: React.createElement(
    DI,
    null,
  ...
  parallelchannel: React.createElement(
    DI,
    null,
  ...
  regressionchannel: React.createElement(
    DI,
    null,
  ...
  gannsquare: React.createElement(
    DI,
    null,
  ...
  triangle: React.createElement(
    DI,
    null,
    React.createElement('polygon', {
      points: '7,2 12,12 2,12',
      stroke: 'currentColor',
      strokeWidth: 1.2,
      strokeLinejoin: 'round',
      fill: 'none',
  ...
  text: React.createElement(
    ...
    React.createElement(
      'text',
      { x: 3, y: 11, fontSize: 11, fontWeight: 700, fontFamily: 'serif', fill: 'currentColor' },
      'T',
    ),
  ),
  callout: React.createElement(
    DI,
    null,
    React.createElement('rect', {
      x: 1.5,
  ...
  pricerange: React.createElement(
    DI,
    null,
    React.createElement('line', { x1: 2, y1: 3, x2: 12, y2: 3, stroke: 'currentColor', strokeWidth: 1, opacity: 0.6 }),
    React.createElement('line', {
  ...
  longposition: React.createElement(
    DI,
    null,
    React.createElement('rect', {
      x: 3,
  ...
  shortposition: React.createElement(
    DI,
    null,
    React.createElement('rect', {
      x: 3,
  ...
  flatbottom: React.createElement(
    DI,
    null,
    React.createElement('line', {
      x1: 2,
  ...
  // ── Patterns ──
  elliott: React.createElement(
    DI,
    null,
    React.createElement('polyline', {
      points: '1,10 3,4 5,8 8,2 10,6 13,10',
      stroke: 'currentColor',
      strokeWidth: 1.2,
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  xabcd: React.createElement(
    DI,
    null,
    React.createElement('polyline', {
      points: '1,8 4,3 7,9 10,5 13,11',
      stroke: 'currentColor',
      strokeWidth: 1.2,
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  headshoulders: React.createElement(
    DI,
    null,
    React.createElement('polyline', {
      points: '1,10 3,6 5,10 7,3 9,10 11,6 13,10',
      stroke: 'currentColor',
      strokeWidth: 1.1,
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
...
export function TIcon({ id }: { id: string }) {
  return (TOOL_ICONS[id] ||
    React.createElement('span', { style: { fontSize: 13 } }, id[0]?.toUpperCase())) as React.ReactElement;
}
...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'abcpattern', label: 'ABC Pattern', category: 'patterns', tier: 'advanced', points: 3 },
  { id: 'cypher', label: 'Cypher Pattern', category: 'patterns', tier: 'advanced', points: 5 },

  // Shapes (additional)
  { id: 'arc', label: 'Arc', category: 'shapes', tier: 'common', points: 3 },
  { id: 'polygon', label: 'Polygon', category: 'shapes', tier: 'advanced', points: Infinity },
  { id: 'highlighter', label: 'Highlighter', category: 'shapes', tier: 'common', points: 2 },
  { id: 'circle', label: 'Circle', category: 'shapes', tier: 'common', points: 2 },

  // Lines (additional)
  { id: 'trendangle', label: 'Trend Angle', category: 'lines', tier: 'common', points: 2 },
  { id: 'disjointangle', label: 'Disjoint Angle', category: 'lines', tier: 'advanced', points: 3 },

  // Measure (additional)
  { id: 'pctchange', label: '% Change', category: 'measure', tier: 'common', points: 2 },
  { id: 'barscount', label: 'Bars Count', category: 'measure', tier: 'common', points: 2 },
  { id: 'riskReward', label: 'Risk/Reward', category: 'measure', tier: 'common', points: 3 },

  // Gann (additional)
  { id: 'gannbox', label: 'Gann Box', category: 'gann', tier: 'advanced', points: 2 },

  // Text (additional)
  { id: 'pricetag', label: 'Price Tag', category: 'text', tier: 'common', points: 1 },
  { id: 'arrowmark', label: 'Arrow Mark', category: 'text', tier: 'common', points: 1 },
  { id: 'flagmark', label: 'Flag Mark', category: 'text', tier: 'common', points: 1 },

  // Forecasts (new category)
  { id: 'projection', label: 'Projection', category: 'forecasts', tier: 'advanced', points: 3 },
  { id: 'dateForecast', label: 'Date & Price Range', category: 'forecasts', tier: 'advanced', points: 2 },
];

// ─── Derived lookups ─────────────────────────────────────────────

/** Flat map of id → label */
export const TOOL_LABELS: Record<string, string> = Object.fromEntries(TOOL_DEFS.map((t) => [t.id, t.label]));
...
export const DRAWING_GROUPS: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      { id: 'trendangle', name: 'Trend Angle' },
      { id: 'disjointangle', name: 'Disjoint Angle' },
    ],
  },
  {
    id: 'fib',
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'emoji', name: 'Emoji' },
      { id: 'pricetag', name: 'Price Tag' },
      { id: 'arrowmark', name: 'Arrow Mark' },
      { id: 'flagmark', name: 'Flag Mark' },
    ],
  },
  {
    id: 'measure',
    ...
    tools: [
      ...
      { id: 'pctchange', name: '% Change' },
      { id: 'barscount', name: 'Bars Count' },
      { id: 'riskReward', name: 'Risk/Reward' },
    ],
  },
  {
    id: 'trading',
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'abcpattern', name: 'ABC Pattern' },
      { id: 'cypher', name: 'Cypher Pattern' },
    ],
  },
  {
    id: 'forecasts',
    ...
    tools: [
      ...
      { id: 'dateForecast', name: 'Date & Price Range' },
    ],
  },
];
...
export const GROUP_ICONS: Record<string, React.ReactNode> = {
  ...
  forecasts: TOOL_ICONS.trendline, // reuse trendline icon for forecasts
};
