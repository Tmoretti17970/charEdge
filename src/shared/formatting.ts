...
/**
 * Format a price with locale-aware decimal/thousands separators.
 * Sprint 9 #73: Consolidated from ChartAccessibility.ts.
 * @param price  - Numeric price value
 * @param decimals - Number of decimal places (default: 2)
 * @returns Formatted price string, or '—' for null/NaN
 */
