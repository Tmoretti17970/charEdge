...
export class ProModeKeyMap {
  ...
  enable(): void {
    ...
    // Store for cleanup
    (this as unknown)._keyUpHandler = keyUpHandler;
  }
  ...
  disable(): void {
    ...
    if ((this as unknown)._keyUpHandler) {
      document.removeEventListener('keyup', (this as unknown)._keyUpHandler);
      (this as unknown)._keyUpHandler = null;
    }
