...
export class CompareOverlay {
    ...
    constructor(primaryBars = [], primarySymbol = '') {
        this.primary = { symbol: primarySymbol, bars: primaryBars, color: 'var(--c-fg-primary, #ececef)' };
    ...
    get symbolCount() { return 1 + this.overlays.size; }
    get symbols() { return [this.primary.symbol, ...this.overlays.keys()]; }
}
