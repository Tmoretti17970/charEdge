...
import {
  ...
  getTodayKey,
  getDateKey,
} from './gamification/challengeSlice';
...
const useGamificationStore = create((...a) => {
  ...
  return {
    ...
    enabled: false, // Phase 4: Off by default — users opt-in via Settings

    notificationPrefs: {
      levelUp: false, // Phase 4: No level-up modals by default
      achievements: false, // Phase 4: No achievement toasts by default
    },
