  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      >
        ...
        <div
          style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20, position: 'relative', zIndex: 1 }}
        >
          <div
            style={{
              width: 48,
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 16, fontWeight: 800, color: '#fff', fontFamily: F }}>{username}</div>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 700, fontFamily: M, color: rank.color }}>{rank.name}</span>
              <span style={{ fontSize: 10, color: alpha('#fff', 0.5), fontFamily: M }}>· Lv.{rank.level}</span>
            </div>
          </div>
          {/* charEdge branding */}
          <div
        ...
        <div style={{ marginBottom: 18, position: 'relative', zIndex: 1 }}>
          ...
          >
            <span style={{ fontSize: 10, fontFamily: M, color: alpha('#fff', 0.6) }}>{xp.toLocaleString()} XP</span>
            {progress.nextRank && (
        ...
        >
          {[
            ...
            <div key={i} style={{ flex: 1, textAlign: 'center' }}>
              <div style={{ fontSize: 16, fontWeight: 800, fontFamily: M, color: '#fff' }}>{stat.value}</div>
              <div
                style={{
                  fontSize: 8,
                  fontWeight: 600,
